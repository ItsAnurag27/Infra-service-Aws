...
# PHASE 1H: Wait for Jenkins to be fully ready
echo ""
echo "PHASE 1H: Jenkins finalizing startup..."
sleep 30  # Wait for Jenkins to fully stabilize
...
echo "   3. Navigate to 'New Item' to create pipeline jobs"
echo "   4. Use 'Pipeline' job type and configure as needed"
echo ""
